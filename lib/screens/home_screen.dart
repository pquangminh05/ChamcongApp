...
class HomeScreen extends StatelessWidget {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, '/employee_info');
                        },
                        child: _buildMenuItem(
                          icon: Icons.person,
                          label: 'Thông tin\nnhân viên',
  ...
  // Hàm để lấy tên hiển thị từ user
  String _getDisplayName(User? user) {
    if (user == null) return 'Người dùng';

    // Ưu tiên displayName nếu có
    if (user.displayName != null && user.displayName!.isNotEmpty) {
      String fullName = user.displayName!;
      // Rút gọn tên nếu quá dài (giống như "Phạm Qua...")
    ...
    if (user.email != null && user.email!.isNotEmpty) {
      ...
      // Capitalize first letter và rút gọn nếu cần
